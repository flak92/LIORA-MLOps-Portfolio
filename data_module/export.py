...
One file per asset: research_artifacts/<TICKER>/canonical_1m.parquet with pure
...
def main() -> int:
    ap = config.ticker_parser("ohlcv_1m_canonical -> research_artifacts/<T>/canonical_1m.parquet")
    args = ap.parse_args()
