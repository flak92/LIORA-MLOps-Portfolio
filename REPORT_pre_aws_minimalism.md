...
| the image carries the code | the image registry (Amazon ECR) for the one image | described, not reached: here the image carries the pins and `.:/app` carries the code |
