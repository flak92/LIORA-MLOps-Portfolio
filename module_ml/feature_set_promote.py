...
def main() -> int:
    ...
    parser.add_argument("--proposal", type=int, default=1, help="the proposal's rank in the search result")
    ...
    for ticker in config.parse_tickers(args.tickers):
        ...
        columns_by_timeframe = feature_set_search.as_tuples(proposals[args.proposal]["columns_by_timeframe"])
