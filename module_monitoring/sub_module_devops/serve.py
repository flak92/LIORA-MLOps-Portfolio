"""The DevOps panel's own server: the one process that speaks the Docker Engine API.
    ...
    GET  /api/image                    the image this container runs — the monitoring module's
...
def image_payload(hostname: str) -> dict:
    """The image this container runs — the monitoring module's, shared by the three residents — named by this container rather than by a literal."""
