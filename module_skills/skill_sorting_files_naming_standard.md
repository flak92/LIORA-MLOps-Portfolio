...
will land in, on any server, under any locale. *The repository shows the destination, not the road*: the order is designed; the crawler reads the listed files against it and gates nothing (`skill_scalability_crawler.md`).
