...
will land in, on any server, under any locale. *The repository shows the destination, not the road*: the order is designed; the crawler counts the family tokens it can read and gates nothing (`skill_scalability_crawler.md`).
